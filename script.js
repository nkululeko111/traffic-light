...
var robot = new Robot(TrafficLight.Red);
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, robot.changeLightAfterDelay(TrafficLight.Yellow, 10000)];
            case 2:
                _a.sent(); // 10 seconds
                return [4 /*yield*/, robot.changeLightAfterDelay(TrafficLight.Green, 10000)];
            case 3:
                _a.sent(); // 10 seconds
                return [4 /*yield*/, robot.changeLightAfterDelay(TrafficLight.Red, 10000)];
            case 4:
                _a.sent(); // 10 seconds
                _a.label = 5;
            case 5:
